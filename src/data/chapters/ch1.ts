...
export const CH1: ChapterData = {
  ...
  campScenes: {
    ...
    3: {
      ...
      desc: '风雪漫天，一道白衣身影立于山门之前。她说："去武当山。" 那是墨绐青最后的嘱咐，也是你踏上武林之路的第一步。',
      actionLabel: '与柳清寒相遇', actionEvent: 'act4_snow',
    },
    4: {
      id: 'ch1_wudang_gate',
      title: '初入武当',
      ...
      npc: { name: '柳清寒', sub: '武当大师姐', img: 'picture/Female-main/柳清寒.png' },
      desc: '武当山在望。漫漫长路，终于到了。柳清寒在前方引路，沉默而稳定，如她的剑。第二章的旅程，即将开始。',
      actionLabel: '踏入武当山门', actionEvent: 'enter_chapter2',
    },
  },
  finalAct: 3,
};
