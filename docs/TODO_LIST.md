...
| v2.7 | 朝廷属性经验权重+UI可见性（政务弹窗/日常任务/宗门任务三处显示属性成长） | ✅ | StoryPanel + MissionPanel + MissionSystem |
| v2.8 | NPC中性互动+交友可见性+游说登庸多因素说服 | ✅ | NpcBehavior + RelationPanel + NPCManager |
...
- **已完成**：沙盒核心循环 / v1.9 / v2.0 / v2.4 / v2.5 / v2.6 / v2.7 / v2.8 / P6-P9 / Direction A-K / 称号系统 / NPC寿命-死亡 / 势力AI增强 / 掌门管理面板 / 朝廷属性经验权重+UI可见性 / NPC中性互动 / NPC交友可见性 / 游说登庸多因素说服
- **进行中**：无
...
| 朝廷属性经验可见性 | 政务弹窗/日常任务/宗门任务三处显示属性成长 + 检定属性经验权重分配 | ✅ |
| NPC中性互动 | tickNpcPlayerInteraction 中性好感 NPC 也会主动互动（寒暄/闲聊/搭话/小买卖），25%概率 | ✅ |
| NPC交友可见性 | NPC详情弹窗关系区显示好友/仇敌标签（从 npcRelationship 读取） | ✅ |
| 游说登庸 | canPersuadeNpc 多因素说服（势力实力+志向+性格+好感），UI显示说服因素 | ✅ |
